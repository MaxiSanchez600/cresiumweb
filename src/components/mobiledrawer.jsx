...
import { Navbar, Logo, Button } from "./index";
import useLanguageSwitch from "../hooks/useLanguageSwith";
import LanguageSelector from "./languageselector";

const MobileDrawer = () => {
  const { handleselectlanguage, currentLanguage } = useLanguageSwitch();
  const languages = [
  ...
  return (
    <div className="">
      <div className="float-right" onClick={() => setOpen(true)}>
        <svg
